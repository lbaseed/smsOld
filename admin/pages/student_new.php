                ...
                <div class="box-body">
                	...
                	<?php
                      ...
                      if(isset($_POST['go'])){
                        ...
                        $stmt = $pdo->prepare("insert into transaction values(:ref, :studentID, :fees, :amountPaid, :balance, :term, :session)");
                        ...
                        $chck = $stmt->execute(['$phone']);
                        if($chck->countRow() > 0) { $q2="done";}
                            else{
                                $stmt = $pdo->prepare("insert into parents values(:email, :lastName, :otherNames, :address, :phone, :password)");
                	...
                	<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" id="form_new">
                    	...
                    	<div class="input-group col-lg-10">
                        	<span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                            <input type="text" class="form-control " placeholder="Last Name" value="" name="lastName" id="lname"/>
                        </div>
                    	<br>
                        <div class="input-group col-lg-10">
                        	<span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                            <input type="text" class="form-control" placeholder="First Name" value="" name="firstName" id="fname"/>
                        </div>
                        <br>
                        <div class="input-group col-lg-10">
                        	<span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                            <input type="text" class="form-control" placeholder="Other Names" name="otherNames" id="oname" value="" />
                        </div>
                        <br>
                        ...
                        <br>
                         <div class="input-group">
                            ...
                            <option value="SELECT">Select Class</option>
                                    ...
                                    $stmt = $pdo->prepare("select * from classes order by `classid` ASC");
