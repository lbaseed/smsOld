...
function test($currClass){
	global $pdo;
	$theader = '
			<center><img src="../files/school/logo.jpg" width="100" height="100" /><br>
				<b>Longer Name of School</b><br>
				<b>Broad Sheet for '.$currClass.'</b><br><br>
			</center>
		...
		<table width=1200>
				...
				//tables rows
						...
						$stmt = $pdo->prepare("SELECT * FROM students WHERE class =? AND subClass=? ");
						$stmt->execute([$mclass, $sclass]);
